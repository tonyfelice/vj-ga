...
(function (window, undefined) {
	...
	,inits = function () {
		...
		//once the loop has finished, check the length of logHistory, and if set, push to CV5 as a visit level
		if(logHistory.length > 0){
		    window._gaq.push(['_setCustomVar', 5, 's', logHistory, 2]);
		}
		console.log('logHistory len:'+logHistory.length);
		console.log('logHistory val:'+logHistory);
	    }
	};
	window.checkSocial = testSocial;  //promote the fn to global
}(window));
