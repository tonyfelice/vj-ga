...
(function (window, undefined) {
	...
	,loadScr = function () {  
		...
		script = scripts[i];
		loader('http://vj-ga.googlecode.com/svn/trunk/vj_ga_'+script+'.js');
	    }
	};
...
(function (window, undefined) {
	...
	,inits = function () {
	    ...
	    if(window._test('__utmb',1) == false){
...
_vj.checkSocial({
    beaconName: 'app id from service'//example// ,facebook: '1234567890'
	    ...
	    _vj.bakery.bake('mycky',999,30);
	    console.log('logged');
	    console.log(_vj.bakery.eat('mycky',true));
	    console.log('logged');
