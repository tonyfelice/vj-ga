...
TO DO:
    ...
    linkbypost
    allowDomain regex
    multiple tracker support - keep secondary intact
...
/*
~*~*~*~*~*~*~*~*~*~*~*~*~*
x-domain linkage and event handlers
~*~*~*~*~*~*~*~*~*~*~*~*~*
*/
...
// event proxy function to catch from "forms and clicks" - also exposed to flash, so please do not change fn name, and make sure this remains at window scope
...
(function (window, undefined) {
    ...
    //do the work
    ,inits = function () {
	//determine whether or not to run (only want to fire on session start) use utmb
	if(_vj.bakery.eat('__utmvj',1) == false){
	    ...
	    _vj.bakery.bake('__utmvj','session initialized',false);
	}
    };
...
/*
~*~*~*~*~*~*~*~*~*~*~*~*~*
cvTools: This section configures 4 of the 5 available Custom Variables.
