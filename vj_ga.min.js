...
~*~*~*~*~*~*~*~*~*~*~*~*~*/
try{
    if(_vj.userDefined !== false && _vj.userDefined.length > 0 && (_vj.cookeez.eat('__utmud') === false)){
...
jQuery(function() {
    ...
    function logWindow(){
	try{
	    if(_vj.cookeez.eat('__utmlw') == false){  //only perform on first run
		...
		_vj.cookeez.bake('__utmlw', 'init', false);
	    }
	}catch(err){
...
(function (window, undefined) {
	...
	if(_vj.cookeez.eat('__utmvj') == false){
