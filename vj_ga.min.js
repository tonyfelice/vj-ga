...
/*
~*~*~*~*~*~*~*~*~*~*~*~*~*
make cookies! YUM!  bakery functions credited to http://www.quirksmode.org/js/cookies.html, with minor and architectural mods
~*~*~*~*~*~*~*~*~*~*~*~*~*
*/
(function (window, undefined) {
    ...
    window._vj.bakery = bakery;  //promote the fn to global
}(window));
...
(function (window, undefined) {
    ...
    window._vj.checkSocial = checkSocial;  //promote the fn to global
}(window));
